...
#pragma config(Motor,  mtr_S1_C1_1,     motorDriveLF,  tmotorTetrix, openLoop, driveLeft)
#pragma config(Motor,  mtr_S1_C1_2,     motorDriveLM,  tmotorTetrix, openLoop, driveLeft)
#pragma config(Motor,  mtr_S1_C2_1,     motorDriveLR,  tmotorTetrix, openLoop, driveLeft)
#pragma config(Motor,  mtr_S1_C2_2,     motorDriveRF,  tmotorTetrix, openLoop, reversed, driveRight)
#pragma config(Motor,  mtr_S1_C3_1,     motorDriveRM,  tmotorTetrix, openLoop, reversed, driveRight)
#pragma config(Motor,  mtr_S1_C3_2,     motorDriveRR,  tmotorTetrix, openLoop, reversed, driveRight)
#pragma config(Motor,  mtr_S1_C4_1,     motorLift1,    tmotorTetrix, openLoop)
#pragma config(Motor,  mtr_S1_C4_2,     motorLift2,    tmotorTetrix, openLoop)
#pragma config(Servo,  srvo_S2_C1_1,    servoHopperTilt1,     tServoStandard)
#pragma config(Servo,  srvo_S2_C1_2,    servoHopperTilt2,     tServoStandard)
#pragma config(Servo,  srvo_S2_C1_3,    servoHopperRamp,      tServoStandard)
#pragma config(Servo,  srvo_S2_C1_4,    servoIntakeTilt1,     tServoStandard)
#pragma config(Servo,  srvo_S2_C1_5,    servoIntakeTilt2,     tServoStandard)
#pragma config(Servo,  srvo_S2_C1_6,    servoIntakeRoller1,   tServoContinuousRotation)
#pragma config(Servo,  srvo_S2_C2_1,    servoIntakeRoller2,   tServoContinuousRotation)
#pragma config(Servo,  srvo_S2_C2_2,    servoLatch,           tServoStandard)
